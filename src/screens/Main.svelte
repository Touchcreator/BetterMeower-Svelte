...
<script>
	...
	import SearchResults_U from "./SearchResults_U.svelte"
	import SearchResults_P from "./SearchResults_P.svelte"
...
<div class="main-screen">
	...
	<div class="view"> 
		...
		{:else if $page === "settings"}
			<Settings />
		{:else if $page === "developersettings"}
			<DeveloperSettings />
		{:else if $page === "groupcat"}
			<Groupcat />
		{:else if $page === "groupchat"}
			<Groupchat />
		{:else if $page === "searchres_U"}
			<SearchResults_U />
		{:else if $page === "searchres_P"}
			<SearchResults_P />
		{:else if $page === "blank"}
			<div></div>
		{:else}
...
<style>
	...
	:not(main.layout-new) .transition {
